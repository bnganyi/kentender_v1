...
# Full Strategy Alignment UI shell — typography gate first, then complete nav smoke.
ui-strategy-alignment-ui-gate: ui-strategy-typography-gate
	cd $(BENCH_ROOT)/apps/kentender_v1 && npx playwright test --workers=1 \
		tests/ui/smoke/strategy-alignment/strategy-alignment-nav.spec.ts
