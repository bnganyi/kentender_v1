...
| `PLN-CHG-015` | Procurement Planning workspace deferred state variants PLN-UI-01A–F | Yes | Yes | Yes | Existing scenarios plus resettable boundaries | Under review |
