...
**Version:** 2.0  
**Supersedes:** Version 1.1 and all Ministry-specific seed contracts  
...
No Demand, reservation, commitment or expenditure record is required for the county fixture at this stage.

## 7. Downstream funding story

All current downstream records belong to `PE-MOH` / `MOH-DIR-DHP`.
...
No Demand, reservation, Tender or Contract is initially required for `PE-MOH` / `MOH-DIR-HRMD`. Its KES 80 million remains fully available. The county line also remains fully available.
...
1. Sign in as the Medical Services unit officer and show the Digital Health and Policy-owned Strategy targets and Draft Budget line.
2. Attempt to open or mutate the Human Resources Management and Development Draft line and show that access is denied.
3. Sign in as the Public Health and Professional Standards unit officer and show its minimal workforce-capability target and Budget line.
4. Sign in as a Ministry reviewer or authority and show the consolidated Ministry Budget and both organisational contributions.
...
7. Sign in as the Kisumu health officer and show the county-owned cold-chain target and Budget line.
8. Attempt to open a Ministry Draft record from the county account and show that access is denied.
9. Explain that the same KenTender ownership model supports different public-entity structures without hardcoded hierarchy levels.
