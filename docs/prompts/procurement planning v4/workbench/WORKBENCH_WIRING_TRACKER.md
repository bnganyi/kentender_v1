...
| W5 | Needs Planning Actions | `Add to Active Plan`, `Create Package`, `View Demand` | ✅ Done | Floating selection toolbar ported verbatim from the companion "2. Needs planning - selection" design; `include_pp_demand_in_procurement_plan`, `create_pp_package_from_planning_inclusion` |
