...
| Change type | New. Extracts rules previously duplicated across AUTH-ADR-001, CFG-CHG-002 and NDS-CHG-001 |
...
**Head of Procurement is not Procurement Planner.** Mercy Kilonzo owns the annual procurement plan; Charles Mutiso owns the annual asset disposal plan. They are separate registry entries under AUTH-ADR-001 §4.4 and may be held by different people.
...
On approval, KT-STD-001 v1.1 becomes the single source for KenTender design-input mechanics, page behaviour, implementation standards, verification protocol, release evidence, document structure, shared fixtures, universal prohibitions and error-contract conventions.
...
v1.2 adds section 3A. v1.1 added sections 10 and 11 to v1.0, and completes the shared fixture register in §8.3 and §8.4A with the actors and instants required by STR-CHG-001, BUD-CHG-001, PLN-CHG-001 and DSP-CHG-001. Nothing else changes. Existing citations of KT-STD-001 v1.0 and v1.1 remain valid.
