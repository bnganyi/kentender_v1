...
**Status:** Phases 0–1 Done 19 September 2026 (old module retired without migration; canonical world reseeded through `requisitions`). Phase 2 (contracts + schema) next.
