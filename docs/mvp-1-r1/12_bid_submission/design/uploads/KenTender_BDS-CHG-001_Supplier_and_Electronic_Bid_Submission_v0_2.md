...
| Supersedes | On approval, v0.1 in full |
...
| v0.2 change scope | Complete STD-to-UI generation boundary, renderer/product-profile contract, product-family extension rule, 10 acceptance criteria and 10 reimplementation rows |
...
| `account_status` | `Active` or `Suspended`; status controls access, not procurement eligibility. |
| `record_version` | Optimistic-concurrency token. |

Creating or activating an Account proves only that the user controls the configured communication channel and may act within the Account. It does not prove ownership, tax compliance, reservation entitlement, capacity, responsiveness or qualification.
...
| No active supplier Account | Register organisation | Authenticated person | Creates Active identity/access Account after required communication verification; no qualification claim. |
...
| Ready to submit | Sign and submit | Authorised Signatory | Revalidates, verifies licensed signature, freezes the Version, deposits it in the closed tender box and issues a receipt atomically. |
...
| Replacement Draft ready; before deadline | Sign and submit replacement | Authorised Signatory | Accepts a new Version and atomically marks the former Submitted Version Superseded. |
...
3. Email/phone verification proves control of the communication channel, not the underlying legal fact.
...
4. The final action is labelled **Submit bid**. The confirmation explains that the bid will be digitally signed, locked and placed in the electronic tender box; it will not be opened or evaluated.
...
|---|---|
| `RegisterSupplierOrganisation` | Validate identity/access fields; create or return one organisation Account; claim no external verification. |
...
| `StartBid` | Recheck Tender open state, Account, definition compatibility and uniqueness; create or return one Draft. |
...
Supply **KT-STD-001 v1.6 §2 plus this section only** to the design tool. Apply KT-STD-001 §2.2, §2.6–2.8, except that these bidder artboards use the Website portal shell defined below instead of Frappe Desk. Fixture metadata remains outside the artboard. Every variant is an isolated reset unless the primary lifecycle explicitly links it.
...
### 10.1 Website shell and shared fixture pack
...
| Submitted | Mary Wanjiku · 10 Jun 2027, 14:32 EAT |
...
| Item | Quantity | Unit | Unit price excluding tax | Tax | Total |
|---|---:|---|---:|---:|---:|
| Business laptops | 250 | Each | KES 160,000.00 | KES 6,400,000.00 | KES 46,400,000.00 |
...
| Deadline passed | Trusted time is 12 Jun 2027, 11:00:01 EAT; Draft was never submitted. |
...
**Joint-venture variant BDS-DES-03-JV.** After Organisation details, show Arrangement **Joint venture**; Joint-venture name; Lead organisation; member table with Legal name, Registration number, Country, Action; Joint-venture agreement upload. Primary **Create arrangement**. Use no fixture rows in the base artboard.
...
**Fixture context — outside the artboard.** David Ouma; Supplier Representative; Afya Digital Supplies Limited; 10 Jun 2027, 09:00 EAT; primary bid Draft.
...
3. Fixture row: Tender title first line and TND reference beneath; BID-MOH-2027-033-001; **Draft · Ready to submit**; 12 Jun 2027, 11:00 EAT; 10 Jun 2027, 08:45 EAT; primary **Review bid**.
...
**Fixture context — outside the artboard.** David Ouma; Supplier Representative; BID-MOH-2027-033-001 Draft Version 7; 10 Jun 2027, 09:00 EAT; all preparation tasks complete.

**Page header.** Title **Your bid**. Place Tender title and references beneath on separate muted lines. Description **Complete the five tasks below before an Authorised Signatory submits the bid.** Badge **Ready to review**. Primary **Review bid** at right.
...
3. Five-row task table with columns Task; Status; Updated; Action. Rows:
   ...
   - Review and submit / Ready / — / **Review bid**.
4. Beneath table show **Saved 10 Jun 2027, 13:50 EAT by David Ouma.** Do not show a percentage, system counts, manifest version or technical validation keys.

**Variants.**

- **BDS-DES-06-IN-PROGRESS:** Requirements status Needs attention; Price status In progress; header badge **2 tasks need attention**; primary **Continue bid** opens Requirements.
...
2. Table columns Item; Quantity; Unit; Unit price excluding tax; Tax; Total. Render the single fixture row. Quantity and Unit read-only; price/tax editable; Total read-only.
...
2. Amber Review note **Physical tender-security original recorded as received on 10 Jun 2027, 10:00 EAT.** In the Security-outstanding variant use the warning copy from BDS-DES-08 instead.
3. Summary grid with separately labelled Tender; Bidder; Bid; Current deadline; Signatory; Bid total.
4. Section **Bid tasks** with the five task rows and Complete/Ready results; each preparation task offers **Review**.
...
**Needs-attention variant BDS-DES-11-ATTENTION.** Red result **Fix 2 items before submitting**. List exact issue links **Replace the rejected product datasheet** and **Confirm the current delivery location**. Submit absent; primary **Fix first item**.
...
**Page header.** Back to review. Title **Submit bid**. Description **Digitally sign and place this bid in the electronic tender box.** Badge **Ready**. No header action.
...
2. Section **Submission summary** with Tender; Bidder; Bid; Bid total; Current deadline; Addendum acknowledged; tender-security physical receipt.
3. Section **Authorised Signatory** with Mary Wanjiku; Managing Director; authority evidence Available; digital certificate **Ready**.
4. Required final confirmation: **I confirm that the information, declarations and evidence in this bid are correct and that I am authorised to submit it for Afya Digital Supplies Limited.** Starts unchecked.
5. Footer: secondary **Cancel**; primary **Submit bid**, disabled until confirmation.

**Confirmation dialog.** Heading **Submit this bid?** Show Tender; Bidder; Bid total; Deadline as four labelled rows. Text **KenTender will apply your digital signature and submit this exact Version to the electronic tender box. Wait for the submission receipt before leaving.** Footer Cancel / primary **Sign and submit**.
...
1. Receipt card with separately labelled Receipt reference `RCPT-MOH-2027-033-001`; Tender; Bidder; Bid; Submission Version 1; Submitted by Mary Wanjiku; Received 10 Jun 2027, 14:32 EAT; Status Submitted.
...
**Deadline-passed variant BDS-DES-13-CLOSED.** Omit replacement/withdraw actions; show **Submission changes closed on 12 Jun 2027, 11:00 EAT.** Receipt remains downloadable.
...
**Withdrawal dialog.** Heading **Withdraw this bid?** Show Tender; Bid; current receipt; deadline. Required Reason textarea. Consequence **The bid will no longer be considered. You may submit a new replacement before the deadline. The submitted history will not be deleted.** Footer Keep bid / destructive **Withdraw bid**.
...
|---|---|---|---|
| Sign-in required | Sign in to continue | Sign in to start or continue a bid for this Tender. | Sign in |
...
| Tender not found | Tender not found | This Tender is unavailable or the reference is incorrect. | Back to Tenders |
| Format unsupported | Bid format unavailable | This Tender's electronic response format is not supported. No bid was created. | Contact support |
| Load failure | Bid could not be loaded | Your saved bid has not changed. | Try again |
| Stale Draft | Bid changed | Another organisation member changed this Draft. Reload and compare before saving. | Reload |
| Evidence rejected | File not accepted | The selected file failed the stated type, size or security check. | Choose another file |
| Submission unavailable | Submission service unavailable | Your bid remains saved and has not been submitted. | Contact support |
| Confirmation pending | Submission confirmation pending | Do not submit again. KenTender is checking whether the electronic tender box accepted this exact bid. | View status |
| Deadline passed | Submission deadline passed | The deadline was 12 Jun 2027, 11:00 EAT. This Draft was not submitted. | Back to My bids |
| Tender cancelled | Tender cancelled | This Tender no longer accepts bids. View the cancellation notice for details. | View notice |
...
| Artboard | Primary actor | Purpose | Required variants |
|---|---|---|---|
| BDS-DES-01 | Public visitor | Find Tenders | Filtered empty. |
| BDS-DES-02 | Public / supplier | Review current Tender | Signed out; Draft; Submitted; Cancelled. |
| BDS-DES-03 | Authenticated person | Register supplier organisation | Joint venture. |
| BDS-DES-04 | Authorised Signatory | Manage Account | Incomplete Account. |
| BDS-DES-05 | Supplier user | Find organisation bids | Submitted; Withdrawn; Empty. |
| BDS-DES-06 | Supplier user | Understand remaining bid work | In progress; Addendum review; Representative-ready. |
| BDS-DES-07 | Supplier Representative | Review documents/addenda | Complete; No addendum. |
| BDS-DES-08 | Supplier Representative | Complete company/declarations/security | Security outstanding; Joint venture. |
| BDS-DES-09 | Supplier Representative | Respond to requirements/evidence | Response drawer; Needs attention; Addendum changed. |
| BDS-DES-10 | Supplier Representative | Enter price | Incomplete. |
| BDS-DES-11 | Supplier / Signatory | Review complete bid | Needs attention; Representative. |
| BDS-DES-12 | Authorised Signatory | Sign and submit | Confirmation; Pending; Signature unavailable; Service unavailable. |
| BDS-DES-13 | Authorised Signatory | Prove submission | Deadline closed. |
| BDS-DES-14 | Authorised Signatory | Replace or withdraw | Replacement receipt; Withdrawal dialog/acknowledgement. |
| BDS-DES-15 | Procurement receipt owner | Record physical security receipt | Recorded. |
| BDS-DES-16 | All | Recover from common states | All table variants. |
...
11. Dates and deadlines display EAT; the final Submit page also displays the trusted current server time.
...
| Start bid | Calls `StartBid`; if Account/arrangement is missing, routes to the exact prerequisite. |
...
| Visible control | Behaviour |
|---|---|
| Create account | Calls `RegisterSupplierOrganisation`; opens Account on success. |
...
| Create arrangement | Calls `CreateBidderArrangement`; validates lead, members, permission and agreement evidence. |
...
| Sign and submit | Calls `PrepareBidSignature`, completes the approved signature flow and then calls `SubmitBid` with the signed exact package and one idempotency key. |
...
|---|---|---|
| 18 May 2027 09:10 | Register Afya Digital Supplies Limited | Active identity/access Account; no qualification claim. |
...
| 10 Jun 2027 14:15 | Mary reviews | Ready to submit. |
| 10 Jun 2027 14:32 | Mary signs and submits | Test signature verifies; Test Tender Box accepts Version 1; receipt `RCPT-MOH-2027-033-001`. |
...
| Cross-organisation denial | Unassigned user requests primary workspace; response masks record existence. |
...
| Custody definitely failed | Test Tender Box reports definitive rejection; Draft preserved; no receipt. |
| Custody uncertain | Correlation pending; no retry, receipt or Submitted state until reconciled. |
| Late submission | Complete request reaches server at 12 Jun 2027 11:00:01 EAT; rejected; no envelope/receipt. |
...
4. retire v0.1 and the earlier bidder-workspace package as implementation authority while retaining them only as reference history; and
...
The following 100-row register is the minimum reimplementation scope: 90 retained v0.1 rows plus 10 v0.2 STD-generation and product-profile rows. **Completion evidence** means tested, reviewable evidence; a mock-up or assertion is insufficient.
...
| BDS01-IMP-082 | Implement all 16 artboards and every isolated state from the self-contained §10 design contract, using KT-STD-001 v1.6 §2. | §§10–11 | Artboard inventory and visual acceptance. |
...
| BDS01-IMP-088 | Trace every BDS01-AC criterion and every register row to an automated, manual, legal, security or usability verification result. | §§14–15 | Complete bidirectional traceability matrix. |
