...
| Supersedes | On approval, v0.2 in full |
...
| v0.3 change scope | Corrected artboard chronology and status semantics; Tender-bound joint-venture creation; contact verification; suspended-account, conflict, custody and deadline states; exact error copy; separate supplier/Desk shells; responsive contract; receipt timestamps; price and withdrawal clarity; 18 acceptance criteria and 18 reimplementation rows |
...
3. Fixture row: Tender title first line and TND reference beneath; BID-MOH-2027-033-001 with secondary **Draft Version 7**; status **Ready to submit**; 12 Jun 2027, 11:00 EAT; 10 Jun 2027, 14:15 EAT; primary **Review bid**.
...
3. Five-row task table with columns Task; Status; Updated; Action. Rows:
   ...
   - Review and submit / Complete / 10 Jun 2027, 14:15 / **Review bid**.
...
| BDS-DES-02 | Public / supplier | Review current Tender | Signed out; Joint-venture start; Draft; Submitted; Cancelled. |
| BDS-DES-03 | Authenticated person | Register supplier organisation | Verification. |
| BDS-DES-04 | Authorised Signatory | Manage Account | Incomplete Account; Pending verification. |
...
| BDS-DES-11 | Supplier / Signatory | Review complete bid | Evidence attention; Addendum attention; Representative. |
| BDS-DES-12 | Authorised Signatory | Submit the reviewed bid | Confirmation; Pending; Signature unavailable; Service unavailable. |
...
| ID | Acceptance criterion |
|---|---|
| BDS03-AC-001 | Every artboard fixture time is at or after every fact rendered as already completed; the primary My bids/workspace fixture is 10 Jun 2027, 14:20 EAT and is consistent with the 13:50 save and 14:15 review. |
...
4. retire v0.2 and all earlier bidder-workspace versions as implementation authority while retaining them only as reference history; and
...
The following 118-row register is the minimum reimplementation scope: 90 retained v0.1 rows, 10 retained v0.2 STD-generation/product-profile rows and 18 v0.3 consistency/recovery rows. **Completion evidence** means tested, reviewable evidence; a mock-up or assertion is insufficient.
...
| ID | Required implementation | Contract | Completion evidence |
|---|---|---|---|
| BDS03-IMP-001 | Render the primary My bids/workspace only at 10 Jun 2027, 14:20 EAT or later so the 13:50 save and 14:15 review are already true; reject visual fixtures containing future-completed facts. | §§10.6–10.7, 13.3, 14.9 | Chronology assertion across every displayed event and artboard snapshot. |
