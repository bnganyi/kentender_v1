...
| Field | Exact value |
|---|---|
| Need 1 | `NDS-MOH-2027-0003` · Version 2 · Human Resources Management and Development · Clinical training laptops for digital health rollout · 100 each |
...
| Need 2 | `NDS-MOH-2027-0004` · Version 1 · Digital Health · Clinical deployment laptops for digital health rollout · 150 each |
...
- KT-STD-001 v1.2 — document structure, design closed-input rules, artboard shell, shared fixture register, common page behaviour, verification protocol, release evidence, seed conventions, universal prohibitions and error conventions;
...
**Partially resolved.** TPR-CHG-001 v0.5 §9.5 now publishes `actual_invitation_date` to `RecordTenderMilestoneActual`, triggered once a downstream publication-consumption process — itself not yet designed — acknowledges the Tender was actually published. `actual_bid_opening_date` and the five milestones after it remain null in production: bid opening belongs to a future Evaluation and Award module, and the remaining milestones belong to that module and a future Contract Management module, neither of which exists yet. This is named here as a tracked dependency rather than left to be rediscovered.
