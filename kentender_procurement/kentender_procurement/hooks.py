...
app_include_css = [
	...
	f"/assets/kentender_procurement/css/it_wizard_it_requirements_page.css?v={_desk_asset_v('public/css/it_wizard_it_requirements_page.css')}",
	f"/assets/kentender_procurement/css/it_wizard_implementation_schedule_page.css?v={_desk_asset_v('public/css/it_wizard_implementation_schedule_page.css')}",
	f"/assets/kentender_procurement/css/it_wizard_system_inventory_page.css?v={_desk_asset_v('public/css/it_wizard_system_inventory_page.css')}",
	f"/assets/kentender_procurement/css/it_wizard_price_schedule_page.css?v={_desk_asset_v('public/css/it_wizard_price_schedule_page.css')}",
	f"/assets/kentender_procurement/css/it_wizard_evaluation_setup_page.css?v={_desk_asset_v('public/css/it_wizard_evaluation_setup_page.css')}",
	f"/assets/kentender_procurement/css/it_wizard_forms_and_evidence_page.css?v={_desk_asset_v('public/css/it_wizard_forms_and_evidence_page.css')}",
	f"/assets/kentender_procurement/css/it_wizard_scc_page.css?v={_desk_asset_v('public/css/it_wizard_scc_page.css')}",
	f"/assets/kentender_procurement/css/it_wizard_validation_report_page.css?v={_desk_asset_v('public/css/it_wizard_validation_report_page.css')}",
	f"/assets/kentender_procurement/css/it_wizard_review_and_approval_page.css?v={_desk_asset_v('public/css/it_wizard_review_and_approval_page.css')}",
	f"/assets/kentender_procurement/css/it_wizard_render_preview_page.css?v={_desk_asset_v('public/css/it_wizard_render_preview_page.css')}",
	f"/assets/kentender_procurement/css/it_wizard_publication_readiness_page.css?v={_desk_asset_v('public/css/it_wizard_publication_readiness_page.css')}",
]
app_include_js = [
	...
	f"/assets/kentender_procurement/js/it_wizard_engine.js?v={_desk_asset_v('public/js/it_wizard_engine.js')}",
	f"/assets/kentender_procurement/js/it_wizard_downstream.js?v={_desk_asset_v('public/js/it_wizard_downstream.js')}",
...
page_js = {
	...
	"it-tender-configuration-it-requirements": "public/js/it_wizard_it_requirements_page.js",
	"it-tender-configuration-implementation-schedule": "public/js/it_wizard_implementation_schedule_page.js",
	"it-tender-configuration-system-inventory": "public/js/it_wizard_system_inventory_page.js",
