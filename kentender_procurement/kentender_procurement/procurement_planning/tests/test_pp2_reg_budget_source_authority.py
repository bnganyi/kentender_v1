...
"""PP2-REG-2 / PP2-REG-002 — Planning does not mutate budget line authority."""
...
class TestPP7BudgetSourceAuthorityP2Reg2(IntegrationTestCase):
	def setUp(self):
		super().setUp()
	...
	def test_pp2_reg_002_planning_pipeline_preserves_budget_authority(self) -> None:
		if self._skip:
