...
@frappe.whitelist()
def get_pp_planning_evidence_timeline(package_code: str | None = None) -> dict[str, Any]:
	"""Whitelisted PP2 Planning Evidence timeline for a procurement package."""
	...
	return get_planning_evidence_timeline(code, frappe.session.user)
