<!-- The six requester-entered values, read-only. §11.1 six-field arrangement:
     title/description/expected result full width, quantity+unit side by
     side, required by on its own row — a §4.10-labelled kt-factstack, not a
     bordered blueprint card (NDS-DES-05/06/07/09/12). -->
<template>
	<div>
		...
		<div class="kt-factstack" style="margin-top: var(--kt-space-4); margin-bottom: var(--kt-space-4)">
			<div>
				<div class="kt-label">Requirement title</div>
				<div class="kt-factstack-value">{{ revision.title }}</div>
			</div>
			<div>
			...
			<div style="display: flex; gap: var(--kt-space-6)">
				<div>
