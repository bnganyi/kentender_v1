...
<div><h2 class="font-headline-sm">No annual plan</h2><p data-kt-pln-no-plan-msg>No annual Procurement Plan exists for this context.</p></div>
</div>
</section>
...
<div class="kt-pln-work-controls">
...
<thead><tr><th>Work item</th><th>Type</th><th>Organisation Unit</th><th class="text-right">Amount</th><th>Why it is waiting</th><th>Status</th><th>Action</th></tr></thead>
<tbody data-kt-pln-waiting-body></tbody>
	...
	<p class="kt-pln-empty-detail text-outline">All pending actions have been completed.</p>
	</div>
</section>
</div>
</main>
