...
3. Module audit events — deferred to R7-003 when G0-001-05 field mapping is confirmed.
...
```python
{
  ...
  "handoff_code": str | None,  # handoff_code (None for addendum events)
  "evidence_refs": list[str],  # object_code values from evidence_links_json.links
}
```
