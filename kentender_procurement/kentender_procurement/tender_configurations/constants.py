...
# Legacy alias retained for existing rows / thin shims (v7 removes Send as a primary step).
...
TAB_TO_STATUS = {
	...
	TAB_NEEDS_ATTENTION: (STATUS_NEEDS_ATTENTION, STATUS_RETURNED_FOR_CORRECTION),
	TAB_READY_FOR_REVIEW: (STATUS_READY_FOR_REVIEW, STATUS_UNDER_REVIEW),
	TAB_READY_FOR_PUBLICATION: (STATUS_APPROVED_FOR_PREVIEW, STATUS_READY_FOR_PUBLICATION),
	TAB_COMPLETED: (
		STATUS_COMPLETED,
		STATUS_AWAITING_PUBLICATION_SETUP,
		STATUS_SENT_TO_PUBLICATION,
