...
"""Shared helpers for STD production UI static layout guards."""
...
def design_source_path(ui_folder: str) -> Path:
	return _kentender_v1_root() / "docs" / "std-prod-impl" / "ui" / ui_folder / "code.html"


def deployed_asset_path(filename: str) -> Path:
	return _procurement_public_root() / "std_prod_impl" / filename
