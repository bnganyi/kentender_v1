...
export const KT_CL_TOOLBAR_PAGE_TITLE = '[data-testid="kt-cl-toolbar-page-title"]';
export const KT_CL_TOOLBAR_TITLE_SEP = '[data-testid="kt-cl-toolbar-title-sep"]';
export const KT_CL_TOOLBAR_SEARCH = '[data-testid="kt-cl-toolbar-search"]';
export const KT_CL_TOOLBAR_NOTIFICATIONS = '[data-testid="kt-cl-toolbar-notifications"]';
export const KT_CL_TOOLBAR_HELP = '[data-testid="kt-cl-toolbar-help"]';
export const KT_CL_TOOLBAR_AVATAR = '[data-testid="kt-cl-toolbar-avatar"]';
...
export async function expectKtClShellChrome(page: Page) {
	...
	await expect(page.locator(KT_CL_TOOLBAR_SEARCH)).toHaveCount(0);
	await expect(page.locator(`${KT_CL_TOOLBAR} ${KT_CL_BREADCRUMBS}`)).toBeVisible();
	await expect(page.locator(`${KT_CL_TOOLBAR} ${KT_CL_BREADCRUMB_CURRENT}`)).toHaveText(/Procurement Home/i);
	await expect(page.locator('[data-testid="kt-cl-page-header"] [data-testid="kt-cl-breadcrumbs"]')).toHaveCount(0);
	await expect(page.locator(KT_CL_TOOLBAR_NOTIFICATIONS)).toBeVisible();
	await expect(page.locator(KT_CL_TOOLBAR_HELP)).toBeVisible();
	await expect(page.locator(KT_CL_TOOLBAR_AVATAR)).toBeVisible();
	await expect(page.getByTestId("kt-cl-toolbar-user-name")).not.toBeEmpty();
