/**
 * One-off MCP screenshot capture for P5B-008 tracker evidence.
 * Run: node scripts/capture-p5b008-screenshots.mjs
 */
...
await page.waitForSelector('[data-testid="pp2-evidence-drawer"]', { state: 'visible', timeout: 30_000 });
await page.screenshot({
	path: path.join(outDir, 'p5b008_packages_evidence_drawer_open_mcp.png'),
	fullPage: true,
});
console.log('saved p5b008_packages_evidence_drawer_open_mcp.png');
await browser.close();
console.log('done');
