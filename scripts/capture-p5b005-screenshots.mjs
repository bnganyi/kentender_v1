/**
 * One-off MCP screenshot capture for P5B-005 tracker evidence.
 * Run: node scripts/capture-p5b005-screenshots.mjs
 */
...
const FIXTURE_ITEM = {
	id: 'pkg-moh-2026-002',
	title: 'Regional Clinic Extension Works',
	subtitle: 'Works · Open Tender · 42,000,000 KES',
	status_label: 'In Preparation',
	funding_label: 'Budget not linked',
	blocker_count: 2,
	blockers: [
...
await page.waitForSelector('[data-testid="pp2-blocker-summary"][data-blocker-state="multiple"]', {
	timeout: 30_000,
});
await page.screenshot({
	path: path.join(outDir, 'p5b005_packages_multiple_blockers_mcp.png'),
	fullPage: true,
});
console.log('saved p5b005_packages_multiple_blockers_mcp.png');
await browser.close();
console.log('done');
