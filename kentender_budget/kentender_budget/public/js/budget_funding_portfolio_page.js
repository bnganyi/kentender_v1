...
(function () {
	...
	function mountWithDeps(page) {
		...
		if (page._ktBudPortfolioLoading) {
			return;
		}
		page._ktBudPortfolioLoading = true;
		frappe.require(
			[
				"/assets/kentender_core/js/kt_form_errors.js",
				"/assets/kentender_budget/js/budget_live_bind.js",
				"/assets/kentender_budget/js/budget_ui_fixtures/portfolio.js",
			],
			function () {
				page._ktBudPortfolioLoading = false;
				mount(page);
			}
		);
	}
