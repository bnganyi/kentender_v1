				...
				<div class="kt-card kt-blueprint" style="padding: 0">
					...
					<div style="padding: 20px 24px; border-bottom: 1px solid var(--kt-color-divider)">
						...
						<template v-else-if="state === 'blocked'">
							...
							<p class="kt-muted" style="font-size: 13px; margin: 0">{{ __("Funds requiring review still count as reserved. You cannot release them from this screen.") }}</p>
						</template>
						...
						<div v-else-if="state === 'closed'" data-testid="bud-close-closed">
							<h3 class="kt-card-title" style="display: flex; align-items: center; gap: 6px"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M3.85 8.62a4 4 0 0 1 4.78-4.77 4 4 0 0 1 6.74 0 4 4 0 0 1 4.78 4.78 4 4 0 0 1 0 6.74 4 4 0 0 1-4.77 4.78 4 4 0 0 1-6.75 0 4 4 0 0 1-4.78-4.77 4 4 0 0 1 0-6.76Z" /><path d="m9 12 2 2 4-4" /></svg>{{ __("Closed") }}</h3>
							<div class="kt-grid-3" style="gap: 16px">
