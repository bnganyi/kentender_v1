...
const props = defineProps({
	...
	// Optional reason textarea (BUD-CHG-001 §12.5: "Return opens a dialog
	// containing only Return reason, Cancel and Return" — reused here rather
	// than a bespoke dialog, since it's the same confirm/cancel shell).
