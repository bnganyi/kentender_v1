...
def execute():
    create_donor_industry_page()


def create_donor_industry_page():
    frappe.db.sql("DELETE FROM `tabWeb Page` WHERE name = 'industry/donor' OR route = 'industry/donor'")
    frappe.db.commit()

    page = frappe.new_doc("Web Page")
    page.title = "Donor-Funded Procurement Module"
    page.route = "industry/donor"
    page.published = 1
...
.neon-glow {
  box-shadow: 0 0 20px rgba(4,44,105,0.3),
    ...
    <div class="max-w-8xl mx-auto text-center">
      <div class="animate-in mb-12">
        <h1 class="text-3xl md:text-5xl mt-6 font-bold text-gray-600 mb-8 leading-tight">
          Donor-Funded Procurement<br>&amp; Contract Administration Module
        </h1>
        <p class="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto">
          Manages procurement for donor-funded projects and programs
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 animate-in" style="animation-delay: 0.2s;">
        <div class="glass rounded-2xl p-8 text-left card-hover bg-black/5">
          <div class="flex items-start gap-4">
            <i class="fas fa-gavel text-cyan-600 text-3xl mt-1"></i>
            <div>
              <h3 class="text-2xl font-bold text-gray-800 mb-3">Donor Compliance</h3>
              <p class="text-lg text-gray-600">Enforces donor-specific rules and compliance requirements</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass rounded-2xl p-8 text-left card-hover bg-black/5">
          <div class="flex items-start gap-4">
            <i class="fas fa-project-diagram text-cyan-600 text-3xl mt-1"></i>
            <div>
              <h3 class="text-2xl font-bold text-gray-800 mb-3">Project Management</h3>
              <p class="text-lg text-gray-600">Supports project-based procurement, budgeting, and reporting</p>
            </div>
          </div>
        </div>
        ...
        <div class="glass rounded-2xl p-8 text-left card-hover bg-black/5">
          <div class="flex items-start gap-4">
            ...
            <div>
              <h3 class="text-2xl font-bold text-gray-800 mb-3">Transparency &amp; Accountability</h3>
              <p class="text-lg text-gray-600">Enhances transparency, accountability, and audit readiness</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="animate-in" style="animation-delay: 0.4s;">
        <a href="https://edonor.midas.co.ke/#login"
        ...
        <p class="text-gray-600 mt-10 text-lg">Ensure compliance and efficiency in donor-funded projects</p>
      </div>
    </div>
  </div>
</section>
