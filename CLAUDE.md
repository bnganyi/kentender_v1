...
make doctor
make seed-canonical SITE=<site> [THROUGH=budget]   # clear non-canonical rows, reseed KT-STD-001 §8 + SEED-001 up to a stage, validate — runbook: docs/mvp-1-r1/00_common/KenTender_SEED-OPS-001_*.md
