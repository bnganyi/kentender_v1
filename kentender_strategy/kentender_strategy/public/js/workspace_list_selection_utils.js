 ...
 * Keep in sync with `kentender_procurement/.../public/js/workspace_list_selection_utils.js`
 * (same API on `window.KTWorkspaceListSelection`) until a shared package exists.
 */
(function () {
