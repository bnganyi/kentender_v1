// Shared Strategy list-table footer — delegates to kentender_core (canonical Stitch Desk chrome).
...
kentender_strategy.ui_fixtures.tablePaginationFooterHtml = function () {
	if (
		...
		return kentender_core.ui_fixtures.tablePaginationFooterHtml({
			ns: "str",
			testid: "kt-str-table-footer",
		});
	}
	...
	return (
		...
		"</div></div>" +
		'<div class="kt-str-footer-pager flex items-center gap-2" data-kt-str-footer-pager>' +
		'<button type="button" class="kt-str-footer-page-btn" data-kt-str-footer-prev data-kt-footer-prev disabled aria-label="Previous page">' +
		'<span class="material-symbols-outlined text-[16px]">chevron_left</span></button>' +
		'<div class="kt-str-footer-pages flex items-center gap-2" data-kt-str-footer-pages data-kt-footer-pages></div>' +
		'<button type="button" class="kt-str-footer-page-btn" data-kt-str-footer-next data-kt-footer-next disabled aria-label="Next page">' +
