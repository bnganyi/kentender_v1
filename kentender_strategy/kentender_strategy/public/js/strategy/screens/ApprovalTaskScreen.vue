	...
	>
		...
		<template v-else-if="overview">
			<!-- The title, the notices, the tabs and every tab's content now sit
			     inside one bordered panel, with a thin rule between sections
			...
			<div class="kt-card kt-blueprint" style="padding: 0">
				...
				<div v-if="isSubmitted && blockers.future_effective" class="kt-notice is-warning" style="margin: 0 20.4px 20.4px" data-testid="str-future-effective">
				...
				<template v-if="tab === 'overview'">
					...
					<div style="padding: 20.4px; border-top: 1px solid var(--kt-color-divider)" data-testid="str-proposed-plan">
					...
					<div class="kt-grid-2" style="padding: 20.4px; border-top: 1px solid var(--kt-color-divider)">
						<div data-testid="str-submission-card">
				...
				<template v-else-if="tab === 'structure'">
					<div class="kt-editor-grid" style="padding: 13.6px 20.4px 20.4px">
						<div data-testid="str-approval-structure">
						...
						<div style="position: sticky; top: 80px" data-testid="str-approval-node-facts">
				...
				<template v-else-if="tab === 'changes'">
					<div style="padding: 20.4px" data-testid="str-approval-changes">
				...
				<template v-else-if="tab === 'history'">
					<div style="padding: 20.4px" data-testid="str-approval-history">
