...
"""PP2-REG-8 — Run existing STD Admin/STD Engine regression modules."""
...
class TestPP7ExistingStdTestsP2Reg8(IntegrationTestCase):
	def test_pp2_reg_008_std_regression_gate(self) -> None:
