...
def ui_fixture_std_config() -> dict[str, Any]:
	...
	return {
		...
		"supplier_requirements": {
			"requirements": [
				...
				},
				{
					...
					"blocks_submission": "Yes",
					"used_in_evaluation": "No",
					"validation_rule": "Expiry date required",
				},
			]
		},
			...
			"forms": [
				{
					...
					"linked_requirement": "None (Main Document)",
				...
				{
					"label": "Bill of Quantities Template",
					"purpose": "Pricing schedule",
					"attachment_type": "EXCEL",
					"source_output": "Uploaded Template",
					"linked_requirement": "Bill of Quantities requirement",
					"visible_to_supplier": "Yes",
					"in_package": "Yes",
					"status": "Approved",
				},
			],
			...
			"supplier_forms": [
				{
					...
					"description": "Standard organizational details and legal structure declaration.",
					"field_count": 12,
					"icon": "description",
				},
				{
					"label": "Compliance Declaration",
					"code": "compliance_declaration",
					"description": "Mandatory ethical and legal compliance questionnaire.",
					"field_count": 8,
					"icon": "verified_user",
				},
			],
			"missing_requirements": [
				{
					...
					"message": "The 'Contract Terms' section requires a 'Form of Agreement' which is currently not listed.",
				}
			],
		},
				...
				"stages": [
					{
						...
						"description": "Mandatory verification of administrative compliance and statutory documents.",
						"evaluation_type": "Pass / Fail",
						"stage_type": "Preliminary",
						"sequence": 1,
						"linked_requirements": [
							{"label": "Certificate of Inc. — pass/fail"},
							{"label": "Tax Compliance — pass/fail"},
						],
						"minimum_compliance": "100% Mandatory",
						"carry_forward_label": "Carry Forward to Tech",
						"carry_forward": True,
					},
					{
						"code": "technical",
						"name": "Technical Evaluation",
						"description": "Assessment of capacity, methodology, and technical personnel qualifications.",
						"evaluation_type": "Scored",
						"stage_type": "Technical",
						"sequence": 2,
						"linked_requirements": [
							{"label": "Tech Proposal — scored"},
							{"label": "CVs of Staff — scored"},
						],
						"minimum_score": "75.0%",
						"carry_forward_label": "Carry Forward to Financial",
						"carry_forward": True,
						"weight": "70",
					},
					{
						...
						"description": "Arithmetic checks, tax compliance verification, and price schedule analysis.",
						"evaluation_type": "Pass / Fail",
						"evaluation_method": "Lowest Evaluated Responsive Bid",
						"stage_type": "Financial",
						"sequence": 3,
						"linked_requirements": [
							{"label": "Bill of Quantities — financial evaluation"},
						],
						"carry_forward_label": "Carry Forward to Post-Qual",
						"carry_forward": True,
						"weight": "30",
					},
					{
						...
						"description": "Final qualification checks before contract award.",
						"evaluation_type": "Pass / Fail",
						"stage_type": "Post-Qualification",
						"sequence": 4,
						"carry_forward": False,
					},
				],
		...
		"contract_terms": {
			...
			"configuration_status": "In Configuration",
			...
			"terms": [
				...
				},
				{
					...
					"override_allowed": True,
					"approval_required": True,
					"carries_to_contract": "Conditional",
					"visible_to_supplier": "Yes",
				},
				{
					"title": "Retention Money",
					"clause_reference": "FIDIC Red Book Clause 14.3",
					"term_type": "Financial",
					"required": "Yes",
					"default_value": "5% of interim payments",
				...
				},
				{
					...
					"clause_reference": "FIDIC Red Book Clause 8.7",
					"term_type": "Performance",
					"required": "Yes",
					"default_value": "0.1% per day",
					"override_allowed": True,
					"approval_required": True,
					"carries_to_contract": "Yes",
					"visible_to_supplier": "Yes",
				},
				{
					...
					"clause_reference": "FIDIC Red Book Clause 11.1",
					"term_type": "Legal",
					"required": "Yes",
				...
				},
				{
					...
					"clause_reference": "FIDIC Red Book Clause 18.1",
					"term_type": "Legal",
					"required": "Yes",
					"default_value": "Professional Indemnity + CAR",
					"override_allowed": False,
					"approval_required": False,
					"carries_to_contract": "Yes",
					"visible_to_supplier": "After Award",
				},
			],
			"readiness": [
				{"key": "governing_form", "label": "Governing contract form selected", "status": "ok"},
				{"key": "mandatory_terms", "label": "All mandatory terms configured", "status": "ok"},
				{"key": "defaults", "label": "Required terms have default values", "status": "ok"},
				{"key": "override_rules", "label": "Override rules are defined", "status": "ok"},
				{"key": "approval_rules", "label": "Approval rules are defined for editable terms", "status": "ok"},
				{"key": "clause_refs", "label": "Clause references exist where required", "status": "warn"},
				{"key": "carry_forward", "label": "Carry-forward terms are mapped to Contract Management", "status": "ok"},
				{"key": "supplier_visibility", "label": "No internal-only terms are marked supplier-visible", "status": "ok"},
				{"key": "attachments", "label": "No required contract form attachment is missing", "status": "warn"},
			],
		},
		"rules": {
			"rules": [
