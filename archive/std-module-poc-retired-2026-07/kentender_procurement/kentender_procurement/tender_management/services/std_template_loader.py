...
def upsert_std_template(
	...
	doc.template_title = resolve_template_title(doc, {"manifest": manifest})
	method_labels = resolve_procurement_methods(doc, {"manifest": manifest})
	doc.procurement_method_profile = format_procurement_method_profile(method_labels)
