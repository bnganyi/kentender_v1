...
@frappe.whitelist()
def save_std_configurator_technical_json(template_code: str, package_json: Any = None) -> dict[str, Any]:
	return svc.save_technical_json(template_code, _parse_section_data(package_json))
