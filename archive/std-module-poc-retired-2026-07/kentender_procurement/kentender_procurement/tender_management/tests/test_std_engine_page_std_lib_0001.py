...
class TestStdEnginePageStdLib0001(IntegrationTestCase):
	...
	def test_std_engine_advanced_page_js_hook(self) -> None:
		paths = frappe.get_hooks("page_js", default={}).get(PAGE_ADVANCED) or []
	...
	def test_ui_hard_0210_advanced_renderer_includes_pack_selectors(self) -> None:
		...
		self.assertIn("std-advanced-open-technical-json", renderers)
