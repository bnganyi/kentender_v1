...
| 3 | [`3. …guided_configuration_field_model.md`](3.%20procurement_officer_tender_configuration_poc_guided_configuration_field_model.md) | Field groups, metadata, inventory vs `fields.json` | Done | Step **3** tests + `bench --site kentender.midas.com run-tests --app kentender_procurement --module kentender_procurement.tender_management.tests.test_officer_guided_field_registry` · [`officer_guided_field_registry.py`](../../../../kentender_procurement/kentender_procurement/tender_management/services/officer_guided_field_registry.py) · [`procurement_tender.json`](../../../../kentender_procurement/kentender_procurement/kentender_procurement/doctype/procurement_tender/procurement_tender.json) (`og_*` guided columns) | **STD-OFFICER-004** remediation: DocType-bound guided surface + registry completeness assert vs `fields.json`. |
...
| 8 | [`8. …minimal_frappe_implementation_pack.md`](8.%20procurement_officer_tender_configuration_poc_minimal_frappe_implementation_pack.md) | Frappe implementation: server module, form sections, whitelisted methods, officer actions | Done | `bench --site kentender.midas.com migrate` (guided `Procurement Tender` schema) · `test_officer_poc_step8_sync_and_whitelists` · `test_officer_guided_field_registry` · [`merge_officer_overlay_into_configuration`](../../../../kentender_procurement/kentender_procurement/tender_management/services/officer_tender_config.py) (full registry merge + system keys) · [`apply_config_to_tender_doc`](../../../../kentender_procurement/kentender_procurement/tender_management/services/std_template_engine.py) (hydrate `og_*`) · [`procurement_tender.js`](../../../../kentender_procurement/kentender_procurement/kentender_procurement/doctype/procurement_tender/procurement_tender.js) (conditional `hidden_fieldnames`) · `./scripts/bench-with-node.sh build --app kentender_procurement`. | Doc **8** §11 field order + §13 sync: **STD-OFFICER-004**; prior “subset only” gap closed. |
| 9 | [`9. …smoke_test_specification.md`](9.%20procurement_officer_tender_configuration_poc_smoke_test_specification.md) | Smoke path + evidence pack | Partial (extended) | **Desk:** `officer-tender-poc-off-st-desk.spec.ts` — OFF-ST-003 assertions updated for doc **8** §11 section labels (`30.` Tender Identity, `40–50.` …). **API:** `bench … test_officer_poc_step9_doc9_off_st_contracts` (OFF-ST-010–015) · `test_officer_guided_field_registry`. | Playwright full serial path may still flake on modal timing; re-run with live site. **STD-OFFICER-003** `/desk/` routes. |
...
| 3 | Guided field groups / `get_officer_guided_field_model` + form fields | Done | Officer step **3** + `officer_guided_field_registry` + `procurement_tender.json` guided columns. | Doc 3; registry is source for `og_*` DocType fields. |
| 4 | `sync_officer_configuration` → `configuration_json` | Done | `merge_officer_overlay_into_configuration` (registry-wide), `sync_officer_configuration`; step **8** + `test_officer_guided_field_registry` tests. | Doc 8 §9.2 / §13. |
