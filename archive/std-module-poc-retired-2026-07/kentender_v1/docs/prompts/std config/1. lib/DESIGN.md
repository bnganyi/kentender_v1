...
Pixel mockup `code.html` exports hero-scale sizes (28px page title, 24px KPI). **Shipped STD Library UI** uses [KenTender Workbench Typography v1.0](../../architecture/Kentender%20Workbench%20Typography%20v1.0.md) via `std_config_shared.css` + `std_library_page.css` — same Budget / Planning harmonization pass (24px page title, 20px KPI, 13px table). Layout region structure remains mockup-faithful; typography and spacing are operational density.
