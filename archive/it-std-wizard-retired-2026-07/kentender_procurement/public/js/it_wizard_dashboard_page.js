(function () {
	...
	frappe.pages["it-tender-configuration-dashboard"].on_page_load = function (wrapper) {
		frappe.require(SHARED.concat(["/assets/kentender_procurement/js/it_wizard/screens/dashboard.js"]), function () {
			kentender.it_wizard.screens.dashboard.init(wrapper);
		});
	};

	frappe.pages["it-tender-configuration-dashboard"].on_page_show = function (wrapper) {
		frappe.require(SHARED.concat(["/assets/kentender_procurement/js/it_wizard/screens/dashboard.js"]), function () {
			kentender.it_wizard.screens.dashboard.show(wrapper);
		});
	};
})();
